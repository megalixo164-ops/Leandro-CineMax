    ...
    if (this.state.hasError) {
      return (
        <div className="min-h-screen bg-black-deep text-white-ice flex flex-col items-center justify-center p-8">
          <h1 className="text-3xl font-bold text-netflix-red mb-4">Oops, ocorreu um erro!</h1>
          ...
          <button 
            className="mt-8 px-6 py-3 bg-action-green/20 text-action-green rounded-full border border-action-green/30 hover:bg-action-green/30 transition-colors"
