    ...
    <section className="py-16 md:py-24 relative bg-[#0a0a0a]">
      <div className="container mx-auto px-4 md:px-8 max-w-7xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-12 relative">
          ...
          <div className="hidden md:block absolute top-[60px] left-[15%] right-[15%] h-[2px] bg-gradient-to-r from-netflix-red via-netflix-dark to-netflix-red opacity-30"></div>
            ...
            >
              <div className="w-32 h-32 relative mb-6 flex items-center justify-center">
                ...
                <div className={`absolute inset-2 rounded-full border border-transparent bg-clip-padding ${
                  idx === 0 ? 'bg-gradient-to-b from-netflix-red/20 to-transparent' :
                  idx === 1 ? 'bg-gradient-to-b from-netflix-dark/20 to-transparent' :
                  'bg-gradient-to-b from-netflix-red/20 to-transparent'
                }`}></div>
