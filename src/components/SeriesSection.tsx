...
export default function SeriesSection() {
  ...
  return (
    <section className="py-16 md:py-24 relative bg-black-deep/50 border-t border-white/5">
      {/* Background glow */}
      <div className="absolute right-0 top-1/2 -translate-y-1/2 w-[500px] h-[500px] bg-neon-purple/10 rounded-full blur-[120px] pointer-events-none"></div>
      ...
      <div className="container mx-auto px-4 md:px-8 max-w-7xl">
        <div className="flex flex-col lg:flex-row items-center gap-16">
          ...
          <div className="flex-1 lg:pr-8">
            ...
            <a href="https://wa.me/554792733349?text=Gostaria%20de%20realizar%20meu%20teste%20gratis%2C%20no%20Leandro%20CineMax!" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 px-8 py-4 rounded-full bg-neon-purple/20 text-neon-purple hover:bg-neon-purple/30 border border-neon-purple/30 transition-all font-medium">
              Solicitar meu teste grátis <Play className="w-4 h-4 fill-neon-purple" />
            </a>
          </div>
